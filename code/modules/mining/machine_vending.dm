...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		new /datum/data/mining_equipment("50 caps",						/obj/item/stack/f13Cash/caps/fivezero,								5000),
		new /datum/data/mining_equipment("100 caps",					/obj/item/stack/f13Cash/caps/onezerozero,							1000),
		new /datum/data/mining_equipment("150 caps",					/obj/item/stack/f13Cash/caps/onefivezero,							2000),
		new /datum/data/mining_equipment("200 caps",					/obj/item/stack/f13Cash/caps/twozerozero,							3000),
		new /datum/data/mining_equipment("250 caps",					/obj/item/stack/f13Cash/caps/twofivezero,							4000),
